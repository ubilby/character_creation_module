...
def special(char_name, char_class):
    if char_class == 'warrior':
        s = 80 + 25
        return (
            f'{char_name} применил специальное умение «Выносливость {s}»')
    if char_class == 'mage':
        s = 5 + 40
        return (f'{char_name} применил специальное умение «Атака {s}»')
    if char_class == 'healer':
        s = 10 + 30
        return (f'{char_name} применил специальное умение «Защита {s}»')
